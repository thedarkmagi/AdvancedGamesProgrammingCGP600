...
void ParticleGenerator::CalculaterBoundingSphereRadius()
{
	float distance=0;
...
HRESULT ParticleGenerator::LoadObjModel(char * Filename, int shaderFileNumber)
{
	HRESULT hr = S_OK;
...
void ParticleGenerator::Draw(XMMATRIX* view, XMMATRIX* projection)
{
